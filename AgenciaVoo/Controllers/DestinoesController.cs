...
namespace AgenciaVoo.Controllers
{
    public class DestinoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DestinoId,Nome,Email,Celular,RG,Saida,Chegada,Horario")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DestinoId,Nome,Email,Celular,RG,Saida,Chegada,Horario")] Destino destino)
        {
